...
if __name__ == "__main__":
    ...
    if run_cbba_flag:
        ...
        ax1.set_title('Solving time, num_targets_per_agent = ' + str(num_targets_per_agent))
        # create plot
    ...
    ax3.set_title('Solving time for proposed, num_targets_per_agent = ' + str(num_targets_per_agent))
    # create plot
    ...
    if run_cbba_flag:
        ...
        ax4.set_title('Solving time for CBBA, num_targets_per_agent = ' + str(num_targets_per_agent))
        # create plot
    ...
    ax5.set_title('Total distance for proposed, num_targets_per_agent = ' + str(num_targets_per_agent))
    # create plot
