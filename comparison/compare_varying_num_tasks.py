...
if __name__ == "__main__":
    ...
    for num_targets_per_agent in range (2, max_num_targets_per_agent+1, 3):
        ...
        for idx_run in range(num_run):
            ...
            if run_ga_flag:
                t0 = time.time()
                _, _, cost, _, _, _ = GA_Solver.MissionPlanning(
                    agent_position, targets_position, num_cluster, number_of_iterations,
                    population_size, max_iter, world_map,
                    MySimulator.map_width, MySimulator.map_height)
                t1 = time.time()
    ...
    #     ax5.set_title('Computing time for CBBA, num_agents = ' + str(num_agents))
    #     # create plot
    ...
    if run_ga_flag:
        ...
        # ax6.set_title('Computing time for K-GA, num_agents = ' + str(num_agents))
        # # create plot
        ...
        ax7.set_title('Computing time, num_agents = ' + str(num_agents))
        # create plot
        ...
        ax8.set_title('Total distance, num_agents = ' + str(num_agents))
        # create plot
