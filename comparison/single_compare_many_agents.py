...
if __name__ == "__main__":
    ...
    my_distance, my_distance_list, infeasible_flag_my = compute_path_distance_many_agents(path_all_agents)
    ...
    cbba_distance, cbba_distance_list, infeasible_flag_cbba = compute_path_distance_many_agents(path_all_agents)
